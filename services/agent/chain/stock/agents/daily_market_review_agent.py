...
### 1. 市场气氛
在退潮、退潮中继、复苏候选、复苏、高潮/强分歧中选择最贴切的一类，并用空间变化、高标反馈、亏钱效应扩散或缓解、板块轮动/加强举证。
...
### 1. 情绪定位
一句分类结论，随后列 2-4 条市场层事实，并说明关键反证。

### 2. 主线与梯队
逐一列出主线、次主线或候选方向：板块扩散、核心股、连板高度、梯队完整度，以及升级或降级条件。

### 3. 龙头与助攻
列出最高标和核心高标的地位分层、封板节奏、助攻证据和昨日高标反馈。严格区分事实、候选和数据不足。
